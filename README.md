...
На главной странице отображается карта города Москва, с указанием местоположения всех объектов/существ, присутствующих в БД на определённый промежуток времени. В верхней части сайта отображаются карточки видов, присутствующих в БД. На карте может быть сразу несколько индивидуальных особей особей одного и того же вида: например, 2 Бульбазавра. 
...
Каждой индивидуальной особи присваивается ряд параметров: 
- Параметры, наследуемые от вида существа:
  1. ID вида существа
  2. Название вида существа на трех языках (ру., англ., яп.)
  3. Описание вида существа
  4. Ссылка на изображение существа, используемое для отображения местоположения на карте и для создания карточки вида.
...
- Собственные параметры:
  ...
  4. Характеристики особи (уровень, здоровье, атака, защита, спец., скорость)
